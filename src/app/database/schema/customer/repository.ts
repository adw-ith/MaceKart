...
export class CustomerRepository {
    static async createCustomer ( name : string, email : string, phone : number, address : string ) {
        try {
    ...
    static async updateCustomer(name: string | null, email: string, phone: number | null, address: string | null) {
        try {
